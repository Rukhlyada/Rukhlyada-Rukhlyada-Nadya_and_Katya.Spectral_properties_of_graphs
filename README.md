...
**Утверждение** (граница Дельсарта—Хоффмана). Пусть G — r-регулярный граф и λ_k — минимальное собственное число его матрицы смежности M. Тогда мощность любого независимого множества в графе G не превосходит ![alt text](skrin/t4.png) <img src="skrin/t4.png" width="200" />. Независимое множество имеет мощность ![alt text](skrin/t4.png) тогда и только тогда, когда его характеристическая функция есть совершенная раскраска с матрицей параметров _________
